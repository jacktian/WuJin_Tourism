package wujin.tourism.android.childFragment.pubu;
...
public class PullListView1 extends ListView implements OnScrollListener {
	private float mLastY = -1; // save event y
	private Scroller mScroller; // used for scroll back
	private OnScrollListener mScrollListener; // user's scroll listener
	// the interface to trigger refresh and load more.
	private IXListViewListener1 mListViewListener;
	// -- header view
	...
	public void firstonRefresh() {
		mHeaderView.setVisiableHeight(pxToDIP(70));
	...
	public void setXListViewListener(IXListViewListener1 l) {
		mListViewListener = l;
	}
	 ...
	 */
	public interface IXListViewListener1 {
