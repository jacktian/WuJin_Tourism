...
import wujin.tourism.android.childactivity.ShoppingDetailsActivity;
...
public class ShoppingAdapter extends BaseAdapter {
	...
	public ShoppingAdapter(Context context, List<results> infos) {
		this.infos = infos;
			...
			holder.ll_layout.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (infos.get(position).getDetail_info().getDetail_url() == null) {
						Toast.makeText(context, "暂无该商家详情！", Toast.LENGTH_SHORT).show();
					} else {
