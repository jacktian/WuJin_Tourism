...
import wujin.tourism.android.adapter.ShoppingAdapter;
...
public class ShoppingActivity extends BaseActivity implements OnClickListener, IXListViewListener {
	...
	private void initview() {
		...
		if (appaplication.isOpenNetWork()) {
			...
			DialogUtils.getNoInternetDg(ShoppingActivity.this);
		}
	}
	...
	protected void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("购物");
		MobclickAgent.onResume(this);
	}

	protected void onPause() {
		super.onPause();
		MobclickAgent.onPageEnd("购物");
	...
	private void setdata() {
		String msg = URLEncoder.encode("购物");
				...
				new AjaxCallBack<Object>() {
					public void onSuccess(Object t) {
						...
						if (baiduPlace.getStatus().equals("0") && !baiduPlace.getTotal().equals("0")) {
							...
							Toast.makeText(ShoppingActivity.this, "暂无数据", Toast.LENGTH_LONG).show();
						}
					}
	...
	public class MyLocationListener implements BDLocationListener {
		public void onReceiveLocation(BDLocation location) {
			...
			if (lat != null && lon != null && latitude != 4.9E-324 && longitude != 4.9E-324) {
				...
				if (num == 5) {
					Toast.makeText(ShoppingActivity.this, "定位失败，请检查GPS和网络连接是否打开", Toast.LENGTH_LONG).show();
					mLocationClient.stop();
					onLoad();
					num = 0;
				}
