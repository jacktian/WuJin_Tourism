...
public class ZhuSuDetailActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (appaplication.isOpenNetWork()) {
			...
			DialogUtils.getNoInternetDg(ZhuSuDetailActivity.this);
		}
	}
	...
	protected void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("住宿推荐详情");
		MobclickAgent.onResume(this);
	}

	protected void onPause() {
		super.onPause();
		MobclickAgent.onPageEnd("住宿推荐详情");
